const cardDatabase = {
    ...
    // 稻草人
    'scarecrow': {
        id: 'scarecrow', name: '稻草人', type: 'monster',
        cost: { sunlight: 0, food: 8 }, attack: 5, hp: 120, canMove: false, cooldown: 4500,
        color: '#854d0e', range: 0, special: 'aura_attack'
    },

    // 毒菇菇
    'poison-mushroom': {
        id: 'poison-mushroom', name: '毒菇菇', type: 'plant',
        cost: { sunlight: 7, food: 0 }, attack: 15, hp: 80, canMove: false, cooldown: 3500,
        color: '#7c3aed', range: 3, special: 'poison'
    }
};
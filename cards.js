const cardDatabase = {
    ...
    // 新增
    'thorn-vine': { id: 'thorn-vine', name: '尖刺藤蔓', type: 'plant', cost: { sunlight: 5, food: 0 }, attack: 6, hp: 280, canMove: false, cooldown: 3000, color: '#16a34a', range: 1, special: 'thorns' },
    'wild-boar': { id: 'wild-boar', name: '狂暴野猪', type: 'monster', cost: { sunlight: 0, food: 5 }, attack: 28, hp: 160, canMove: true, cooldown: 8000, color: '#b45309', range: 1, special: 'knockback' },
    ...
    // 新增 - 绿色/蓝色
    'scarecrow': { id: 'scarecrow', name: '稻草人', type: 'plant', cost: { sunlight: 8, food: 0 }, attack: 5, hp: 120, canMove: false, cooldown: 4500, color: '#854d0e', range: 2, special: 'fear' },
    'poison-mushroom': { id: 'poison-mushroom', name: '毒菇菇', type: 'plant', cost: { sunlight: 7, food: 0 }, attack: 15, hp: 80, canMove: false, cooldown: 3500, color: '#7c3aed', range: 3, special: 'poison' }
};